...
public class PushMusicCmd implements MqttBaseCmdService {

    public MusicMqttData musicMqttData;

    private MqttUserService mqttService;

    public PushMusicCmd(String cmd, String data, MqttUserService wx2MqttService) {
...
//        System.out.println("发送给前端  内容："+musicData);
